  ...
  return (
    <>
      <Typography variant="body2" color="textSecondary">
        In time attack the goal is to complete the game as fast as possible. The
        target time can be set per player or total. If a player overruns the
        target time, he is marked as DNF. If the total time is overrun, the game
        is marked as DNF.
      </Typography>
