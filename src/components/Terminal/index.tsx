...
const Terminal: FunctionComponent<TerminalProps> = (props) => {
    ...
    const [buffer, setBuffer] = useState<string[]>(["Welcome to the terminal!", "type 'help' to get started"]);
    ...
    const execute = (command: string) => {
        ...
        const commandObj = [...builtInCommands, ...customCommands].find((c) => c.name === cmd);
    ...
    const builtInCommands: Command[] = [
        {
            ...
            execute: (args: string[], buffer: Buffer) => {
                ...
                [...builtInCommands, customCommands[0], customCommands[1]].forEach((c) => {
        ...
        },
        {
            ...
            execute: (args: string[], buffer: Buffer) => {
                files.forEach((f) => {
                    ...
                    buffer.write(`${perm} root root ${rightPad(f.size || "", 5)}  ${f.name}`);
                });
            },
        },
        {
